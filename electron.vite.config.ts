 ...
 * shell is served from `app://tms9918/`, which no link can reach — so a link
 * made there is rooted at the published Pages build instead, and this is where
 * that address is stated for both builds.
 */
const WEB_APP_URL = 'https://acwright.github.io/TMS9918-EDITOR/'
