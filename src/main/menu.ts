...
const PRODUCT_NAME = 'TMS9918 Editor'
const REPO_URL = 'https://github.com/acwright/TMS9918-EDITOR'
  ...
  return [
    ...
    },
    {
      ...
      submenu: [
        ...
        { role: 'selectAll' },
        { type: 'separator' },
        // "Pattern" rather than "Character": the same items edit a sprite in a
        // sprite project, and their labels already say so.
        { label: 'Pattern', submenu: items('pattern') },
      ],
    },
    {
      label: '&View',
