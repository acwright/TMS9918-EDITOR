 ...
 * editor's toolbar wraps onto a second row below 1490 px of viewport in
 * Graphics II, which is the mode whose left column is widest, and the sprite
 * animation toolbar wraps below about 1340. **1200** clears the tallest left
 * column: sprite mode needs 1133 px of viewport before the sprite sheet stops
 * being squeezed against its floor, and the margin above that is what turns
 * "nothing is clipped" into "the picker is worth looking at" — the sheet is
 * 229 px at 1200 against 194 px at the floor.
 *
