 ...
 * and a browser download in a tab. The name is the document one — `Star
 * Voyager.tms9918` — because a copy of a project is a project file, and both
...
<template>
  <div class="flex h-dvh flex-col">
    ...
    <div
      v-if="store.lastNotice && openState === 'ready'"
      class="mx-4 mt-3 flex items-center justify-between gap-3 rounded-sm border border-ink-700 bg-ink-850 px-3 py-2 text-sm text-ink-300"
      role="status"
    >
