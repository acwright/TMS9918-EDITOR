 ...
 * both bases, and which slots are still blank, which is how you find room for a
 * new one.
 *
...
const CHAR_COUNT_CODES = Array.from({ length: 256 }, (_, code) => code)

/** The TMS9918 set is always 256 characters; only the mode changes what it draws. */
const codes = computed(() => (projects.current ? CHAR_COUNT_CODES : []))
