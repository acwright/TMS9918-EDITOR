...
<template>
  ...
  >
    ...
    <div v-if="!finished" class="flex flex-col gap-3 text-sm text-ink-300">
      ...
      <div>
        ...
        <div class="flex items-center gap-2">
          <!-- Left to right, unlike the New dialog's location row: this path
               ...
               "Documents/TMS9918 Editor/~", which is measurably worse than a
      ...
      <p v-if="plan && plan.unreadable.length > 0" class="text-xs text-vdp-dark-red">
    ...
    <div v-else class="flex flex-col gap-3 text-sm text-ink-300">
      ...
      <p v-else class="text-vdp-dark-red">
      ...
      <div v-if="outcome!.failed.length > 0" class="text-xs text-vdp-dark-red">
      ...
      <p v-if="outcome!.unreadable.length > 0" class="text-xs text-vdp-dark-red">
