/**
 * Label casing for assembly export (PLAN.md §12.3). Segments carry canonical
...
export interface LabelCaseInfo {
  ...
  /** Picker label. */
  label: string
  /** Rendering of `char_patterns_1`, shown as the picker's hint. */
  example: string
}

export const LABEL_CASES: readonly LabelCaseInfo[] = [
  { id: 'snake', label: 'snake_case', example: 'char_patterns_1' },
  { id: 'upper', label: 'ALL CAPS', example: 'CHAR_PATTERNS_1' },
  { id: 'camel', label: 'camelCase', example: 'charPatterns1' },
  { id: 'pascal', label: 'PascalCase', example: 'CharPatterns1' },
]
