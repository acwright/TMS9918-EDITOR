...
export const DOCUMENT_EXTENSION = 'tms9918'
 ...
 */
export const LEGACY_DOCUMENT_EXTENSION = 'tms9918.json'

/** What the open and save dialogs call the type in their filter row. */
export const DOCUMENT_TYPE_NAME = 'TMS9918 Project'

/**
 * A project name as a filename (D3).
 *
 * Only what a filesystem refuses is touched — the separators and Windows'
 * reserved set — so "Star Voyager" stays `Star Voyager.tms9918` rather than
 * becoming a slug.
 *
 ...
 */
export const MIGRATION_FOLDER_NAME = 'TMS9918 Editor'
